...
4. [`session-evidence-health.md`](../architecture/session-evidence-health.md);
5. [`deterministic-evidence-contracts.md`](../architecture/deterministic-evidence-contracts.md);
6. [`visual-evidence-review.md`](../operations/visual-evidence-review.md); and
7. [`system-dataflow maintenance`](../../tools/system-diagram/docs/maintenance.md).
...
- Update `tools/system-diagram/docs/system-dataflow.toml`, regenerate the complete artifact set with the
