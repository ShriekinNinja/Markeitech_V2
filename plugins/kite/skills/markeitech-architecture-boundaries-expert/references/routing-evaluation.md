...
expected boundary; it does not observe explicit-Kite selection.
Normal-task dormancy, explicit Kite activation, cross-advisor ordering, and delegated execution
remain `PENDING` until Kite is cache-busted, reinstalled, and exercised in fresh Codex tasks.
