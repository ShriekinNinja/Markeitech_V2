...
- Start from the accepted entity evidence and intended consumer; keep simultaneous opportunities distinct.
- Check transition preconditions, identity, occurrence/knowledge time, evidence references, validity, expiry, and supersession where relevant.
- Specify deterministic non-admission for missing, stale, or conflicting evidence; do not turn a geometric interaction into trade advice.
- Preserve auditability and explicit revisions without adding unrelated persistence or lifecycle machinery.

## Optional References

- [domain-contract.md](references/domain-contract.md) — use for the matching transition, conflict, or revision question.
- [sources.md](references/sources.md) — use for an external event-processing claim needs verification.
