...
expected behavior; it does not prove automatic selection, delegated execution, or PostgreSQL
behavior. Installed results remain `PENDING` until Kite is cache-busted, reinstalled, and exercised
