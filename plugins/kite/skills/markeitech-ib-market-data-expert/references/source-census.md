...
| Third-party integration FAQ | https://ibkrcampus.com/docs/third-party-integrations/general-third-party-frequently-asked-questions | Username-scoped subscriptions, subscription sharing, API-specific permissions, chart differences, no-data and pacing diagnostics | FAQ answers aid classification but do not replace exact account evidence or method documentation. |
